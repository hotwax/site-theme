...
echo "<div id='$cta_id' class='$classes'" . ( !empty( $section_styles ) ? " style='$section_styles'" : "" ) . ">";
	if ( $color_over_img ){
		echo !empty( $img_layer ) ? $img_layer : "";
		echo !empty( $color_layer ) ? $color_layer : "";			
	}
	else{
		echo !empty( $color_layer ) ? $color_layer : "";
		echo !empty( $img_layer ) ? $img_layer : "";
	}
	echo "<div class='cta_holder'>";
		echo !empty( $icon )	 ? "<div class='cta_icon'" . ( !empty( $icon_styles ) ? " style='$icon_styles'" : "" ) . "><i class='fa fa-$icon'></i></div>" : "";
		echo !empty( $text_content ) ? "<div class='cta_content'>$text_content</div>" : "";
		echo !empty( $button ) ? "<div class='cta_button'>$button</div>" : "";
	echo "</div>";
echo "</div>";
?>