...
if ( !empty( $spacing_styles ) || !empty( $color_styles ) ){
	echo "<style type='text/css'>";
		echo !empty( $spacing_styles ) ? "#{$id}{{$spacing_styles}}" : "";
		echo !empty( $color_styles ) ? "#{$id}:before{{$color_styles}}" : "";
	echo "</style>";
}
echo "<hr" . ( !empty( $spacing_styles ) || !empty( $color_styles ) ? " id='$id'" : "" ) . ( !empty( $classes ) ? " class='$classes'" : "" ) . " />";
?>