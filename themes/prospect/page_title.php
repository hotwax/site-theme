...
$title = prospect_get_page_title();
ob_start();
prospect_dimox_breadcrumbs();
$breadcrumbs = ob_get_clean();
$page_title_content = "";
if ( !empty( $title ) ){
	$page_title_spacings = prospect_get_option( 'page_title_spacings' );
...
if ( !empty( $page_title_content ) ){
	echo "<section id='page_title_section'>";
		echo "<div class='prospect_layout_container'>";
			echo "<div class='page_title_content'" . ( !empty( $page_title_content_styles ) ? " style='$page_title_content_styles'" : "" ) . ">" . $page_title_content;
			echo "</div>";
		echo "</div>";
	echo "</section>";
}
