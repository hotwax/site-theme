...
body{
  ...
  --iPhone-width: 243px;
  --iPhone-shadow-width: 394px;
  --iPhone-shadow-height: 605px;
...
/* device styling end */
  ...
  /* @media (prefers-color-scheme: dark) {
    :root{
      --surface: rgba(0, 0, 0, .87);
      --font-color-body: rgb(230, 230, 230);
    }
    .menuwrapper{
...
<div id="home">
 <section id="Job Manager App">
      
      <div class="content">
        <div id="JMAf3" class="feature">
          <h3>
            Heading 1 of Job Manager App
          </h3>
          <p>
            Consolidated content of Job-Manager-App.
          </p>
        </div>
        <div id="JMA3" class="iPhone">
          <img src="https://www.hotwax.co/wp-content/uploads/2021/09/Preorder_3.png" alt="PreOrder Button">
        </div>
        <div id="JMAf4" class="feature">
          <h3>
            Job-Manager-App with estimated delivery date
          </h3>
          <p>
            Job-Manager-App with estimated delivery date on the product detail pages. Automatically converts the “Pre-Order” button to “Add-to-cart” once the product is released and inventory is available. Automatically converts the “Add-to-cart” button to the “Backorder” button if the product is out of stock. 
          </p>
        </div>
        <div id="JMA4" class="iPhone">
          <img src="https://www.hotwax.co/wp-content/uploads/2021/09/Preorder_4.png" alt="BackOrder Button">
        </div>
        <div id="JMAf5" class="feature">
          <h3>
            Job-Manager-App button with estimated delivery date 
          </h3>
          <p>
            Shows the Job-Manager-App and estimated delivery date on the product detail pages when inventory is out of stock. Automatically converts the Job-Manager-App to “Add-to-cart” once the inventory is back in stock.
          </p>
        </div>
        <div id="Releasing">
          <div id="JMAf6" class="feature">
            <h3>
              Job-Manager-App
            </h3>
            <p>
              Job-Manager-App enables merchandisers to reserve some inventory for stores by specifying the quantity of available inventory they want to release for pre-orders that are in the queue.
            </p>
          </div>

          <!-- <div id="JMA1" class="iPad">
            <img src="img/Preorder/Preorder_1.png" alt="Preorder Bulk Releasing">
          </div> -->
          <div id="JMA2" class="iPad">
