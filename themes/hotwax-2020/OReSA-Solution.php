<?php /* Template Name: Store Fulfillment New */ ?>
<?php get_header(); ?>
...
<section id="sfs">
      ...
      <div class="content">
        <div id="sfstablet">
          <div id="sfsf1" class="feature">
            <h3>
              Ship-From-Store
            </h3>
            <p>
              Fulfill online orders from stores for faster delivery to customers.
            </p>
          </div>
          <div id="sfs1" class="iPad">
            <img src="https://www.hotwax.co/wp-content/uploads/2021/09/SFS_1.png" alt="Fulfillment Desktop App">
          </div>
          <div id="sfsf2" class="feature">
            <h3>
              Intelligent Routing
            </h3>
            <p>
              Route online orders to the nearest store to reduce delivery time or route orders to stores that have excess inventory to increase inventory turnover.
            </p>
          </div>
        </div>
        <div id="sfsf3" class="feature">
          <h3>
            Omnichannel Returns and Exchanges
          </h3>
          <p>
            Let customers return or exchange an online order in-store to increase store traffic and create up-sell opportunities.
          </p>
        </div>
        <div id="sfs2" class="iPhone">
          <img src="https://www.hotwax.co/wp-content/uploads/2021/09/SFS_2.png" alt="Omni Returns">
        </div>
        <div id="sfsf4" class="feature">
          <h3>
            Ship-To-Store
          </h3>
          <p>
            Enable customers to pick up their online orders at their convenience from their local store.
          </p>
        </div>
        <div id="sfs3" class="iPhone">
          <img src="https://www.hotwax.co/wp-content/uploads/2021/09/SFS_3.png" alt="Ship to Store">
        </div>
      </div>
    </section>
</div>
