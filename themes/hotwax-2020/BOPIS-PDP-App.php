 ...
 <section id="BOPIS-PDP-APP">
      ...
      <div class="content">
        <div id="POf3" class="feature">
          ...
          <p>
            BOPIS-PDP-APP-1 visibility of future inventory by accessing information from POs and ASNs from the ERP system and communicates this information to the eCommerce platform so that it does not accept orders that cannot be fulfilled.
          </p>
        </div>
        ...
        <div id="POf4" class="feature">
          ...
          <p>
            BOPIS-PDP-APP-2 estimated delivery date on the product detail pages. Automatically converts the “Pre-Order” button to “Add-to-cart” once the product is released and inventory is available. Automatically converts the “Add-to-cart” button to the “Backorder” button if the product is out of stock. 
          </p>
        </div>
        ...
        <div id="POf5" class="feature">
          ...
          <p>
            BOPIS-PDP-APP- 3 and estimated delivery date on the product detail pages when inventory is out of stock. Automatically converts the “Backorder” button to “Add-to-cart” once the inventory is back in stock.
          </p>
        </div>
        <div id="Releasing">
          <div id="POf6" class="feature">
            ...
            <p>
              BOPIS-APP-4 enables merchandisers to reserve some inventory for stores by specifying the quantity of available inventory they want to release for pre-orders that are in the queue.
            </p>
          </div>
