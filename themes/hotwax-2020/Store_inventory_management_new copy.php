<?php /* Template Name: Store Inventory Management New */ ?>
<?php get_header(); ?>
...
<section id="sim">
      ...
      <div class="content">
        <div id="sim1" class="iPhone">
          <img src="https://www.hotwax.co/wp-content/uploads/2021/09/Cycle-Count.png" alt="BOPIS">
        </div>
        <div id="simf1" class="feature">
          <h3>
            Cycle count
          </h3>
          <p>
        ...
        <div id="sim2" class="iPhone">
          <img src="https://www.hotwax.co/wp-content/uploads/2021/09/Picking.png" alt="BOPIS">
        </div>

        <div class="receiving">
          <div id="simf3" class="feature">
            <h3>
              Receiving
            </h3>
            <p>
          ...
          <div id="sim3" class="iPad">
            <img src="https://www.hotwax.co/wp-content/uploads/2021/09/Receiving.png" alt="BOPIS">
          </div>
        </div>
      </div>
    </section>
