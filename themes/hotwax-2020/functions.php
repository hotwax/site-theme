...
if( function_exists('acf_add_options_page') ) {
    ...
    acf_add_options_page(array(
        'page_title'    => 'Theme Gloabal Modules',
        'menu_title'    => 'Gloabal Modules',
        'menu_slug'     => 'theme-general-settings',
        'capability'    => 'edit_posts',
        'redirect'      => false
    ));
    acf_add_options_sub_page(array(
        'page_title'    => 'Header Global Module',
        'menu_title'    => 'Header Global Module',
...
?>
<?php register_nav_menu( 'footer-about', 'Footer About Menu' ); ?>
<?php register_nav_menu( 'footer-solutions', 'Footer Solutions Menu' ); ?>
<?php register_nav_menu( 'footer-products', 'Footer Products Menu' ); ?>
