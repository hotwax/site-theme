...
<style>
	...
	*/
	...
	@media only screen and (max-width: 980px) {
		...
		#storefulfillmentapp1 {
			margin-bottom: 50px;
		}

		#storefulfillmentapp2 {
			margin-block: 50px;
		}

		#storefulfillmentapp3 {
			margin-block: 50px;
		}
	...
	@media only screen and (min-width: 980px) {
		...
		#storefulfillmentappf3 {
			padding-top: 220px;
		}

		#storefulfillmentapp2 > img {
			position: absolute;
			max-width: var(--Mac-width);
			right: 0;
		}

		#storefulfillmentapp3 > img {
			position: absolute;
			max-width: var(--Mac-width);
			left: 0;
		}
...
<div id="home">
	...
	<section id="storefulfillmentapp">
		<!-- 		<div>
<h1>Store Fulfillment App</h1>
<br>
<p>
subtitle
</p>
		...
		<div class="content">
			<div id="storefulfillmentappf1" class="feature">
				<h3>
					Dummy heading 1: storefulfillmentapp
				</h3>
				<p>
					Dummy description 1: storefulfillmentapp
				</p>
			</div>
			<div id="storefulfillmentapp1" class="iPhone">
				<img src="https://www.hotwax.co/wp-content/uploads/2022/10/oresa_1.png" alt="OReSA">
			</div>
			<div id="storefulfillmentapp2" class="Mac-container">
				<img class="Mac" src="https://www.hotwax.co/wp-content/uploads/2022/10/Reconsiliation-Report.png" alt="OReSA">
			</div>
			<div id="storefulfillmentappf2" class="feature">
				<h3>
					Dummy heading 2: storefulfillmentapp
				</h3>
				<p>
					Dummy description 2: storefulfillmentapp
				</p>
			</div>
			<div id="storefulfillmentappf3" class="feature">
				<h3>
					Dummy heading 3: storefulfillmentapp
				</h3>
				<p>
					Dummy description 3: storefulfillmentapp
				</p>
			</div>
			<div id="storefulfillmentapp3" class="Mac-container">
